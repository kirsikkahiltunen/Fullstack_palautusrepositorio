...
describe('Blog app', () => {
    ...
    describe('Login', () => {
        test('Login is successful with correct credentials', async ({ page }) => {
            ...
            await expect(page.getByRole('link', { name: 'new_blog'})).toBeVisible()
    ...
    describe('When logged in', () => {
        ...
        test('a new blog can be created', async ({ page }) => {
            ...
            await expect(page.getByRole('link', {name: 'Uusi blogi by Erkki Esimerkki'})).toBeVisible()
        })
        test('user can like blogs', async ({ page }) => {
            ...
            await page.getByRole('link', {name: 'Uusi blogi by Erkki Esimerkki'}).click()
